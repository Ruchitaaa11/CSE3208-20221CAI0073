...
Original file is located at
    https://colab.research.google.com/drive/16bWOlA380611hAv-dKTbSOeBJ1LTnl3s
"""
...
file1 = open("/content/sample_data/MyFile.txt", "r")
text = file1.read()
print(text)

file1 = open("/content/Test4.txt", "r")
text = file1.read()
print(text)
...
roll_number = "20221CAI0073"
input_filename = 'test4.txt'
output_filename = f"{roll_number}-Lab-02-output.txt"

with open("/content/Test4.txt", 'r') as file:
